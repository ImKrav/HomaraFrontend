...
export default function ProjectDetailPage({ params }: ProjectDetailPageProps) {
    ...
    async function loadData() {
      try {
        ...
        if (res.success && res.data) {
          ...
          // Cargar productos sugeridos según el tipo de material
          const catSlug = res.data.materialType === "pintura" ? "pinturas" : "pisos-ceramicas";
          const suggestedRes = await api.get(`/api/v1/products?category=${catSlug}&limit=4`);
  ...
  // Calcular las deducciones físicas
  ...
  // Intentar obtener el área bruta original
